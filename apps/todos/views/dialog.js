...
*/
SC.DialogPane = SC.PanelPane.extend({
  ...
  */
  ...
  taskTextField: SC.outlet('contentView.childViews.3.childViews.0'),
  ...
  contentView: SC.View.extend({
    ...
    childViews: [
      ...
      SC.View.extend({
        layout: { centerX: 0, height: 20, centerY: 0, width: 200 },
        childViews: [
  ...
  */
  ...
  addTask: function(sender) {
    var del = this.delegate;
    if (del && del.alertPaneDidDismiss) {
      del.alertPaneDidDismiss(this, sender.get('actionKey'));
    }
    if (del && del.dialogPaneDidAdd) {
      var textField=this.get('taskTextField');
      var n = textField.$('input').val();
      del.dialogPaneDidAdd(n);
    }
...
*/
SC.DialogPane._normalizeArguments = function(args) {
...
*/
SC.DialogPane.show = function(message, description, caption, button1Title, button2Title, button3Title, iconUrl, delegate) {
...
*/
SC.DialogPane.info = function(message, description, caption, button1Title, button2Title, button3Title, delegate) {
  var args = this._normalizeArguments(arguments);
